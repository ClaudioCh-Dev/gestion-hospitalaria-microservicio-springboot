        ...
        CommandLineRunner initData(
                ...
                return args -> {
                        ...
                        try {
                                ...
                                PermissionEntity billingTariffCreate = permissionRepository.save(
                                                PermissionEntity.builder()
                                                                .name("BILLING_TARIFF_CREATE")
                                                                .build());

                                log.info("Permiso creado: BILLING_TARIFF_CREATE");

                                PermissionEntity billingTariffUpdate = permissionRepository.save(
                                                PermissionEntity.builder()
                                                                .name("BILLING_TARIFF_UPDATE")
                                                                .build());

                                log.info("Permiso creado: BILLING_TARIFF_UPDATE");

                                PermissionEntity billingTariffRead = permissionRepository.save(
                                                PermissionEntity.builder()
                                                                .name("BILLING_TARIFF_READ")
                                                                .build());
                                ...
                                log.info("Permiso creado: BILLING_TARIFF_READ");
