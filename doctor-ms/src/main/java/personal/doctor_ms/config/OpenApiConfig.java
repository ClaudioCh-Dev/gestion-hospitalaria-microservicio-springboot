package personal.doctor_ms.config;
...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Doctor API", version = "1.0", description = "API para la gestión de doctores y especialidades"))
