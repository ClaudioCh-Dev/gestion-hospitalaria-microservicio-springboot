package personal.notification_ms.config;
...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Notification API", version = "1.0", description = "API para la consulta de notificaciones y su stream en tiempo real"))
